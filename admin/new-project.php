...
require_once "../includes/new_project.inc";
?>
<!--main content start-->
                     ...
                     style="margin-right: 360px; margin-left: 360px">';
                        ...
                        <form class="form-horizontal style-form" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input name="name" type="text" class="form-control round-form centered" autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input id="flat_count" name="flat_count" type="number"
                                           min="1" class="form-control round-form centered">
                                </div>
